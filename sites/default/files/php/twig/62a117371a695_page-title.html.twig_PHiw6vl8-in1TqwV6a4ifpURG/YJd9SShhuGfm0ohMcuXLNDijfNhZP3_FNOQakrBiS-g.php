...
class __TwigTemplate_7c1d8c288aa86fd5f7c3ef1f049ec7a07d02040ab8bcd226545190a97b6f5e54 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["title"] ?? null)) {
            // line 17
            echo "  <h1";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [0 => [0 => "display-4", 1 => "text-center", 2 => "page-title"]], "method", false, false, true, 17), 17, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    {
        return new Source("", "themes/bootstrap5/templates/content/page-title.html.twig", "/Applications/MAMP/htdocs/ahuy/themes/bootstrap5/templates/content/page-title.html.twig");
    }
